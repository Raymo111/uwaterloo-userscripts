//  ___                                        _ __  __                            _   _ ___
// |_ _|_ __ ___  _ __  _ __ _____   _____  __| |  \/  | __ _ _ __ _ __ ___   ___ | | | |_ _|
//  | || '_ ` _ \| '_ \| '__/ _ \ \ / / _ \/ _` | |\/| |/ _` | '__| '_ ` _ \ / _ \| | | || |
//  | || | | | | | |_) | | | (_) \ V /  __/ (_| | |  | | (_| | |  | | | | | | (_) | |_| || |
// |___|_| |_| |_| .__/|_|  \___/ \_/ \___|\__,_|_|  |_|\__,_|_|  |_| |_| |_|\___/ \___/|___|
//               |_|
//
...
function loadMarmoUI(run)
{
	...
	function loadJQuery(run)
	{
		...
		script1.src = getProtocol() + "://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js";
		script1.addEventListener("load", function ()
		{
			var script1 = document.createElement("script");
			script1.type = "text/javascript";
			script1.textContent = "(" + run.toString() + ")()";
			document.body.appendChild(script1);
		}, false);
		appendToHead(script1);
	}
...
function runMarmoUI()
{
	...
	var update_download = "https://github.com/lishid/MarmoUI/blob/master/marmo-ui.user.js"; //Download page
...
// 				{
// 					//First release token
// 					tokens = requestResult.match(/\<li\>[a-zA-Z0-9 ,\:]+\<br\>/g);
